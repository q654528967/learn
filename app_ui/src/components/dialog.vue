        ...
        <div class="hm-dialog__header">
          ...
          <button class="hm-dialog__headerbtn" @click="handleClose">
            <svg class="icon" aria-hidden="true">
              <use xlink:href="#icon-baseline-close-px" />
            </svg>
          </button>
        </div>
...
.hm-dialog__headerbtn .hm-dialog__close {
  color: #909399;
}
.hm-dialog__headerbtn:focus .hm-dialog__close,
.hm-dialog__headerbtn:hover .hm-dialog__close {
  color: #409eff;
}
.hm-dialog__title {
  line-height: 24px;
...
.hm-dialog--center .hm-dialog__body {
  text-align: initial;
  padding: 25px 25px 30px;
}
.hm-dialog--center .hm-dialog__footer {
  text-align: inherit;
}
